...
$query = "select DATE_FORMAT(createdAt,'%b') as mon,sum(s.quantity) as quantity from bloomberg.sales s, bloomberg.fruits f, bloomberg.country c where c.ID = s.countryOfcultivationID and s.fruitID = f.ID" .$where. " group by Month(createdAt)";
